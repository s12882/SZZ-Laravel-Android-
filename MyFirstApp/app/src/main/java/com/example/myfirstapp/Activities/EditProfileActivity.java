...
public class EditProfileActivity extends BasicActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_profile_edit, null, false);
        ...
        sectionDropdown.setSelection(currentUser.getSectionId());
        ...
        sectionDropdown.setSelection(currentUser.getSectionId()-1);
        ...
        rolesDropdown.setSelection(currentUser.getRoleId()-1);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.createUserButton){
            ...
            if (failFlag == false) {
                ...
                Intent myIntent = new Intent(this, SectionHomeActivity.class);
                ...
                if(response.contains("success")){
                    ...
                    Toast toast = Toast.makeText(getApplicationContext(), "Profil zostal zedytowany", duration);
                    toast.show();
                }else{
                    int duration = Toast.LENGTH_SHORT;
                    Toast toast = Toast.makeText(getApplicationContext(), "Wystąpil bląd", duration);
                    toast.show();
                }
