...
public class EditEmployeesActivity extends BasicActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditEmployeesActivity.CustomAdapter adapter = new EditEmployeesActivity.CustomAdapter(this, EditTaskActivity.Employees);
    ...
    class CustomAdapter extends ArrayAdapter<Employee> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            EditTaskActivity.Employees = modelItems;
            return convertView;
        }
    }
